...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cqfbox4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cqfbox4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Samarth-8836/container-cqfbox4.git
cd container-cqfbox4
```
...
```
docker attach container-cqfbox4
```
